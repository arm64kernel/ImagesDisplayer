...
class ImageLoader {
    static func loadAllImageData(fromDirectory directory: String, fileExtension: String = "jpg") -> [ImageData] {
            ...
            for fileURL in fileURLs {
                ...
                if fileURL.pathExtension == fileExtension {
                    ...
                    if let uiImage = UIImage(contentsOfFile: fileURL.path) {
                        ...
                        let newData = ImageData(image: uiImage, description: randomDescription)
    ...
    private static func generateRandomDescription() -> [[String: String]] {
